...
function display(data) {
  data.forEach(function (elem) {
    ...
    main.className = "col";
    let mainin = document.createElement("div");
    mainin.className = "card shadow-sm";
    ...
    img.setAttribute("src", "https://media.licdn.com/dms/image/C4D0BAQFTBz8iVYhLYA/company-logo_200_200/0/1650616228667?e=2147483647&v=beta&t=OZxsWzHUsTdGCNUa8a2zuHA9sp28384Bl1gYqDvVPIA");
    let Id = document.createElement("h5");
    Id.innerHTML = elem.Name;
    ...
    let divbtninside = document.createElement("div");
    divbtninside.className = "btn-group";

    let btn = document.createElement("button");
    btn.className = "btn btn-sm btn-outline-secondary";
    btn.innerHTML = "View";
    divbtn.append(divbtninside);
    divbtninside.append(btn);
    box.append(img, Id, des, divbtn);
